...
const JOB_TYPE = {
    label: "Bounding Box Blender Rendering",
    ...
    settings: [
        ...
        // Nombre del script que se debe ejecutar
        { key: "render_script", type: "string", required: true, visible: "submission",
            description: "Rendering script file to run" },

        // Nombre del objeto para renderizar
        { key: "camera_name", type: "string", default: "Camera", visible: "submission",
            description: "Name of the camera to render" },
        // Nombre de la camara para la vista de renderizado
        { key: "object_name", type: "string", default: "Dado", visible: "submission",
            description: "Name of the object to render" },
...
function authorRenderTasks(settings, renderDir, renderOutput) {
    ...
    //print("Frames total: ", settings.frames);
    ...
    for (let chunk of chunks) {
        //print("DEBUG: authorRenderTasks renderDir: " + renderDir);
        //print("DEBUG: authorRenderTasks blendfile: " + settings.blendfile);
        const blendfile = String(settings.blendfile)
        const scriptfile = blendfile.substring(0, blendfile.lastIndexOf("/")+1) + settings.render_script;
        //print("DEBUG: authorRenderTasks scriptfile: " + scriptfile);
        ...
        const command = author.Command("blender-render", {
            ...
            args: baseArgs.concat([
                ...
                "--python", scriptfile,
                "--",
                "--output", path.join(renderDir, path.basename(renderOutput)),
                "--format", settings.format,
                "--frame", chunk.replaceAll("-", ".."), // Convert to Blender frame range notation.
                "--frames_total", chunks.length,
                "--camera", settings.camera_name,
                "--object", settings.object_name,
            ])
        }, frameCount(chunk));
        task.addCommand(command);
        //print("Author Task variables:")
        //print("Command: ", command);
        //print("Task: ", task);
        //print("Render output: ", renderOutput);
        //print("Render Dir: ", renderDir);
        //print("Blender file: ", settings.blendfile)
